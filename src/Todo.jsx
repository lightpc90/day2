        ...
        <div className="bg-sky-800 w-[90%] h-[150px] text-white flex flex-col justify-center items-center">
          ...
          <div className="flex flex-col">
            <input
              ...
              type="text"
              name="newTodo"
              className="py-1 px-2 border-[2px] rounded-md my-2  border-sky-400 "
            />
            <button
              onClick={addTodo}
              className="bg-sky-700 w-full p-2 rounded-md my-1"
            >
              Add New Todo
            </button>
          </div>
              ...
              todoList.map((todo, i) => (
                <li
                  ...
                  className={`flex justify-between gap-2 rounded-md  p-2 ${
                    todo.completed ? "bg-zinc-100" : "bg-sky-300 shadow-md"
                  }`}
                >
                  <h3
                    className={` ${
                      todo.completed ? "text-gray-400" : "font-semibold"
                    }`}
                  >
                    {todo.title}
                  </h3>
